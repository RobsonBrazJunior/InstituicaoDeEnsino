...
namespace IES.Areas.Cadastros.Controllers
{
    public class DepartamentoController : Controller
    {
        ...
        public async Task<IActionResult> Index() => View(await departamentoDAL.ObterDepartamentosClassificadosPorNome().ToListAsync());
        ...
        private async Task<bool> DepartamentoExists(long? id) => await departamentoDAL.ObterDepartamentoPorId((long)id) != null;

        public async Task<IActionResult> Details(long? id) => await ObterVisaoDepartamentoPorId(id);

        public async Task<IActionResult> Delete(long? id) => await ObterVisaoDepartamentoPorId(id);
